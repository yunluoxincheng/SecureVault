...
@Composable
fun SecuritySessionSettingsScreen(
                    ...
                    Column {
                        ...
                        MyAppDropdownSelector(
                            ...
                            selectedText = SessionTimeoutOptions
                                .firstOrNull { it.timeoutMs == sessionTimeoutMs }
                                ?.label
                                ?: SettingsViewModel.sessionTimeoutLabel(sessionTimeoutMs),
                            options = SessionTimeoutOptions.map { option ->
                                MyAppDropdownOption(option.timeoutMs, option.label)
                            },
