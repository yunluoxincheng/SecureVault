...
data class LayoutTokens(
    ...
    val authFormMaxWidth: Dp = 480.dp,
    ...
    val inlineIndicatorSize: Dp = 8.dp,
    val inlineIndicatorSelectedWidth: Dp = 24.dp,
    val onboardingActionWidth: Dp = 120.dp,
    val onboardingIllustrationSize: Dp = 100.dp,
    val onboardingIllustrationIconSize: Dp = 52.dp,
    val stepperValueMinWidth: Dp = 32.dp,
    val sliderTouchHeight: Dp = 28.dp,
