# android-autofill Specification

## Purpose

Specify how Android Autofill **pending-save drafts** are staged between the system Autofill UI and the in-app add-entry flow: encrypted durability, legacy migration, dual-path resolution with Intent extras, and safe logging.
