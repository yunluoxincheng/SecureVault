...
Ensure vault list UI work respects **structured concurrency** and **request lineage** (`loadRequestId` and navigation disposal) so users never see stuck loading or stale data after tabs or stack changes.
## Requirements
