# android-device-key Specification

## Purpose

Android `PlatformKeyStore` device-key unwrap: callers must distinguish missing key material from decrypt/integrity failures and other Keystore errors, with support-safe diagnostics and no secret leakage in logs or user-visible text.
