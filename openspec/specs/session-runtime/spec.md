...
Define cross-platform **session state safety** (`SessionManager` concurrency) and **Libsodium readiness** before any crypto that depends on native sodium, without tying vault formats or algorithms to a single platform entrypoint.
## Requirements
